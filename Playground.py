...
foil1.WriteUpperC_Alpha([0.3,0.1,0.05,0],[8.3,9,10,12])
...
foil1.WriteLowerC_Alpha([0.1,0.15,0.2,1],[1,2,3,5])
foil1.MPRLower(0.7,0.98,0.4,0.7)
foil1.RampLower(0,0)
...
foil1.inviscidCalc_byIncrements(0,3,7) #-> start at an aoa of 0 and increase by 3 each time for a total of 5 points
